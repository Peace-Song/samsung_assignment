...
def save(checkpoint_dir, net, optim, epoch):
...
def load(checkpoint_dir, net, optim):
...
# configuring network and implementing loss functions
net = Net().to(device)
...
for epoch in range(1, num_epoch + 1):
    ...
    save(checkpoint_dir = checkpoint_dir, net=net, optim=optim, epoch=epoch)
