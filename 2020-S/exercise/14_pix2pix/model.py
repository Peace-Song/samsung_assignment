...
class Pix2Pix(nn.Module):
    def __init__(self, in_channels, out_channels, nker=64, norm="bnorm"):
        ...
        # CBR2d: encoder, discriminator uses conv layer with downsampling factor 2
        # kernel_size=4, relu=0.2, stride=2 as in the paper

        # norm=None: first layer does not have batchnorm
        ...
        # dropout: applied to first 3 layers as in the paper
